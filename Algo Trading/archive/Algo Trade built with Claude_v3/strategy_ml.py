...
class MLStrategy(Strategy):
    ...
    def configure(self, 
        ...
        self.model_lgbm = MultiOutputRegressor(base_model)
    ...
    def train(self, train_data: Dict[str, pd.DataFrame], val_data: Dict[str, pd.DataFrame],
        ...
        val_predictions = self.model_lgbm.predict(X_val_scaled)
    ...
    def __call__(self, portfolio: Portfolio, current_prices: Dict[str, dict], 
        ...
        regime_leverage = self.regime_detector.get_regime_leverage(test_data, weights)
