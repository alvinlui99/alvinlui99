...
from equal_weight_strategy import equal_weight_strategy
...
def main():
    ...
    # Create strategy
    best_model = LSTMEnhancedStrategy()
    ...
    if USE_TRAINED_MODEL:
        ...
        # Train the model
        print("\nTraining model...")
        train_metrics = best_model.train_model(train_data)
        if SAVE_MODEL:
    ...
    test_metrics = best_model.evaluate(test_data)
    ...
    mv_stats, mv_equity, mv_trades = run_backtest(
        best_model, "lstm", symbols, initial_capital, 
